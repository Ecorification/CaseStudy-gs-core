 ...
 * @generated
 */
public class ImplementationsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ImplementationsPackage.ABSTRACT_EDGE: {
				AbstractEdge abstractEdge = (AbstractEdge)theEObject;
				T result = caseAbstractEdge(abstractEdge);
				if (result == null) result = caseAbstractElement(abstractEdge);
				if (result == null) result = caseEdge(abstractEdge);
				if (result == null) result = caseElement(abstractEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImplementationsPackage.ABSTRACT_ELEMENT: {
				AbstractElement abstractElement = (AbstractElement)theEObject;
				T result = caseAbstractElement(abstractElement);
				if (result == null) result = caseElement(abstractElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImplementationsPackage.ABSTRACT_GRAPH: {
				AbstractGraph abstractGraph = (AbstractGraph)theEObject;
				T result = caseAbstractGraph(abstractGraph);
				if (result == null) result = caseAbstractElement(abstractGraph);
				if (result == null) result = caseGraph(abstractGraph);
				if (result == null) result = caseReplayable(abstractGraph);
				if (result == null) result = caseElement(abstractGraph);
				if (result == null) result = casePipe(abstractGraph);
				if (result == null) result = caseStructure(abstractGraph);
				if (result == null) result = caseSource(abstractGraph);
				if (result == null) result = caseSink(abstractGraph);
				if (result == null) result = caseAttributeSink(abstractGraph);
				if (result == null) result = caseElementSink(abstractGraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImplementationsPackage.ABSTRACT_NODE: {
				AbstractNode abstractNode = (AbstractNode)theEObject;
				T result = caseAbstractNode(abstractNode);
				if (result == null) result = caseAbstractElement(abstractNode);
				if (result == null) result = caseNode(abstractNode);
