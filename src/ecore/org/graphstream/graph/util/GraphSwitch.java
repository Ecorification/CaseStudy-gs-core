	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GraphPackage.GRAPH: {
				...
				if (result == null) result = caseElement(graph);
				if (result == null) result = casePipe(graph);
				if (result == null) result = caseStructure(graph);
				if (result == null) result = caseSource(graph);
				if (result == null) result = caseSink(graph);
				if (result == null) result = caseAttributeSink(graph);
				if (result == null) result = caseElementSink(graph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
