 ...
 * @generated
 */
public class StreamFactoryImplOld extends EFactoryImpl implements StreamFactoryOld {
	/**
	 ...
	 * @generated
	 */
	public static StreamFactoryOld init() {
		return new StreamFactoryImplOld();
	}
