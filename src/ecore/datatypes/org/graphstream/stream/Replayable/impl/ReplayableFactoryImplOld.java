 ...
 * @generated
 */
public class ReplayableFactoryImplOld extends EFactoryImpl implements ReplayableFactoryOld {
	/**
	 ...
	 * @generated
	 */
	public static ReplayableFactoryOld init() {
		return new ReplayableFactoryImplOld();
	}
	 ...
	 * @generated
	 */
	public ReplayableFactoryImplOld() {
		super();
	}
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ReplayablePackage.CONTROLLER:
	 ...
	 * @generated
	 */
	public ReplayablePackage getReplayablePackage() {
		return (ReplayablePackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static ReplayablePackage getPackage() {
		return ReplayablePackage.eINSTANCE;
	}

} //ReplayableFactoryImpl
